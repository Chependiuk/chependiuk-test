...
public class NPCPatrol : MonoBehaviour
{
    ...
    [SerializeField] private bool randomWaypointOrder = true; 
    ...
    void Start()
    {
        ...
        // ≤н≥ц≥ал≥зуЇмо список доступних ≥ндекс≥в вейпо≥нт≥в
    ...
    private void SetNewTargetPosition()
    {
        ...
        {
            // якщо вс≥ вейпо≥нти вичерпано, починаЇмо новий цикл
            if (availableWaypointIndices.Count == 0)
            {
                availableWaypointIndices = Enumerable.Range(0, waypoints.Length).ToList();

                // ¬идал€Їмо поточний вейпо≥нт, щоб не йти до нього знову
            ...
            // ¬ибираЇмо випадковий вейпо≥нт з доступних
